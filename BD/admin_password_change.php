...
<head>
<meta charset="UTF-8">
<title>Change Password - RedPulse</title>
...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top">
    ...
    <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
        <ul class="navbar-nav">
            <li class="nav-item"><a class="nav-link" href="admin_profile.php">Dashboard</a></li>
            <li class="nav-item"><a class="nav-link active" href="change_admin_password.php">Change Password</a></li>
        </ul>
    </div>
</nav>
...
<div class="edit-card">
    ...
    <form method="POST">
        ...
        <a href="admin_profile.php" class="btn btn-secondary w-100 mt-2">Cancel</a>
    </form>
</div>
