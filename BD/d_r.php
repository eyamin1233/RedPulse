...
if (isset($_SESSION['donor_message'])) {
    $type = $_SESSION['donor_message_type'] ?? 'info';
    ...
    echo "<div style='padding: 12px 16px;
            ...
            {$_SESSION['donor_message']}
          </div>";

    // Output the redirect script if it's set
    if (isset($_SESSION['redirect_script'])) {
        echo $_SESSION['redirect_script'];
        unset($_SESSION['redirect_script']);
    }

    unset($_SESSION['donor_message']);
    unset($_SESSION['donor_message_type']);
}
?>
...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top">
    ...
    <form action="d_rp.php" method="POST" onsubmit="return validateForm()">
        <div class="row">
            <!-- Left Column -->
            <div class="col-md-6">
...
<script>
    function validateForm() {
        ...
        if (!contactRegex.test(contact)) {
            document.getElementById("contactError").innerText = "Must be 11 digits and start with '01'.";
            isValid = false;
        }

        if (!passwordRegex.test(password)) {
            document.getElementById("passwordError").innerText = "Weak password. Follow the rules below.";
            isValid = false;
        }
    ...
    function checkPasswordStrength() {
        ...
        if (passwordRegex.test(password)) {
            ...
            passwordError.innerText = "Password must include uppercase, lowercase, a number, and be at least 6 characters.";
        }
    }
</script>
