...
<head>
    ...
    <style>
        * {
        ...
        .btn-primary:hover {
            background-color:rgb(221, 21, 11);
            color: #fff;
        }
...
<div class="form_">
    <h4>User Sign In</h4>
    <form action="signprog.php" method="POST">
        <div class="form-group">
            <label for="email">Email</label>
            <input 
                type="email" 
                class="form-control <?= isset($_SESSION['email_error']) && $_SESSION['email_error'] ? 'is-invalid' : '' ?>" 
                id="email" 
                name="email" 
...
<?php endif; ?>
        ...
        <div class="auth-links">
            <small><a href="forgot_password.php" class="text-light">Forgot Password?</a></small>
            <small>Don't have an account? <a href="register.php" class="text-light">Register</a></small>
        </div>
